...
public class OverlayBorderLayout implements LayoutManager2,
     ...
     */
    public OverlayBorderLayout(int hgap, int vgap) {
        this.hgap = hgap;
        this.vgap = vgap;
    }
    ...
    public void layoutContainer(Container target) {
        synchronized (target.getTreeLock()) {
            ...
            if ((c=getChild(NORTH,ltr)) != null) {
                ...
                Dimension d = c.getPreferredSize();
                Insets oi = new Insets(0, 0, 0, 0);
                if(c instanceof OverlayBorderComponent) {
                    oi = ((OverlayBorderComponent) c).getOverlayDimensions();
                    d.width -= oi.left;
                    d.width -= oi.right;
                    d.height -= oi.top;
                    d.height -= oi.bottom;
                }
                c.setBounds(left + oi.left, top + oi.top, right - left + oi.left + oi.right, d.height + oi.top + oi.bottom);
                top += d.height + vgap;
            }
            if ((c=getChild(SOUTH,ltr)) != null) {
                c.setSize(right - left, c.getHeight());
                ...
                c.setBounds(left - oi.left, bottom - d.height - oi.top, right - left + oi.left + oi.right, d.height + oi.top + oi.bottom);
            ...
            if ((c=getChild(EAST,ltr)) != null) {
                ...
                c.setBounds(right - d.width - oi.left, top - oi.top, d.width + oi.left + oi.right, bottom - top + oi.top + oi.bottom);
                right -= d.width + hgap;
            }
            if ((c=getChild(WEST,ltr)) != null) {
                c.setSize(c.getWidth(), bottom - top);
                ...
                c.setBounds(left - oi.left, top - oi.top, d.width + oi.left + oi.right, bottom - top + oi.top + oi.bottom);
                left += d.width + hgap;
            }
            if ((c=getChild(CENTER,ltr)) != null) {
